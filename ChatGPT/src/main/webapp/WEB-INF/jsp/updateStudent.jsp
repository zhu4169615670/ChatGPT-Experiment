...
<div class="layui-content">
    <div class="layui-row">
        <div class="layui-card">
            ...
            <form class="layui-form layui-card-body" action="${pageContext.request.contextPath}/student/doUpdate" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text"  readonly= readonly name="no" required value="${list.no}" lay-verify="required" placeholder="请输入学生姓名" autocomplete="off" class="layui-input" style="width:190px">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">学生班级：</label>
                    <div class="layui-input-block">
                        <input type="text" name="name" required   value="${list.name}"  lay-verify="required" placeholder="请输入学生班级" autocomplete="off" class="layui-input " style="width:190px">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">学生年龄：</label>
                    <div class="layui-input-block">
                        <input type="text" name="age" required  value="${list.age}"   lay-verify="required" placeholder="请输入学生年龄" autocomplete="off" class="layui-input " style="width:190px">
                    </div>
                </div>
