...
<form method="post" action="${pageContext.request.contextPath}/student/findAll" id="listform">
                ...
                <div class="layui-card-body">
                    ...
                    <div class="layui-form layui-form-item">
                        <div class="layui-inline">
                            ...
                            <a href="${pageContext.request.contextPath}/student/toAdd" class="layui-btn "><i
                                    class="layui-icon">&#xe654;</i>添加</a>

                            <div class="layui-form-mid">学生姓名:</div>
                    ...
                    <div class="form-box">
                        ...
                        <table id="table_content" class="layui-table" align="center">
                            ...
                            <c:forEach var="stu" items="${list}">
                                ...
                                <td align="center">
                                    <a href="${pageContext.request.contextPath}/student/toUpdate?id=${stu.id}"
                                       class="layui-btn layui-btn-blue">修改</a>
                                    <a href="${pageContext.request.contextPath}/student/del?id=${stu.id}"
                                       class="layui-btn layui-btn-red" >删除</a>
                                    <a href="${pageContext.request.contextPath}/student/pinfen?id=${stu.id}"
