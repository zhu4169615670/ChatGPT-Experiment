...
<div class="layui-content">
    <div class="layui-row">
        <div class="layui-card">
            <div class="layui-card-header">新增论文信息</div>
            
            <form class="layui-form layui-card-body" enctype="multipart/form-data" action="${pageContext.request.contextPath}/student/doLunWen" method="post">


                <div class="layui-form-item">
                    <label class="layui-form-label">上传论文：</label>
                    <div class="layui-input-block">
                        <input type="file" name="file" required    lay-verify="required" placeholder="请上传论文信息" autocomplete="off" class="layui-input " style="width:190px">
                    </div>
                </div>
