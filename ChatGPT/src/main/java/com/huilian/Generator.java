...
public class Generator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://127.0.0.1:3306/test?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&allowMultiQueries=true&serverTimezone=Asia/Shanghai");
...
//        globalConfig.setOutputDir(System.getProperty("user.dir")+"/mybatis_04-generator/src/main/java");
        ...
        packageConfig.setParent("com.huilian");
        //设置实体类包名
